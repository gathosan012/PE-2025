...
const EditRoomForm = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => console.error("❌ Không thể lấy dữ liệu phòng:", err));
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:5000/api/rooms/${id}`, form, {
        headers: {
  ...
  return (
    <div className="edit-room-wrapper">
      <div className="edit-room-header">
        <h2 className="edit-room-title">Chỉnh sửa Phòng</h2>
